...
while ($ligne=$return->fetch()){
    if($ligne['email']==$_POST['email']){
        if(password_verify($mdp,$ligne['mdp'])){
            ...
            $pseudo=$_POST['pseudo'];
            setcookie('pseudo',$pseudo,time()+(3600*24),null,null,false,true);}else {$mauvaismdp= 'mauvais mot de passe';$mauvaismail="";}
        }else {$mauvaismail="mauvais email";$mauvaismdp="";}
    };
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-10 col-lg-8 col-xl-7 mx-auto">
             <h1 style="color: #b5f2f2";><?php echo $mauvaismail ; ?></h1>
                <h1 style="color: #b5f2f2";><?php echo $mauvaismdp; ?></h1>
            </div>
            <div class="col-md-10 col-lg-8 col-xl-7 mx-auto">
                <a href="index.php"><button class="btn-primary"> Retour</button></a>
            </div>
        </div>
    </div>
</header>
